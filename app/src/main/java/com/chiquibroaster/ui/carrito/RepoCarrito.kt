            ...
            if(it.isSuccessful){
                ...
                for(documentos in it.result!!){
                    ...
                    if(nombre==user&&idUser==userId){
                        ...
                        if(estado!="PENDIENTE"&&estado!="ENTREGADO"&&estado!="CONFIRMADO"){
                            ...
                            val iddel = documentos.getString("idDelivery")
                            val latdel = documentos.get("latitudDelivery").toString()
                            val londel = documentos.get("longitudDelivery").toString()
//
                            val datos = DatosCarrito(producto1, cantPechos, cantPiernas, coca2l, cocazero2l, sprite2l, fantanaranja2l, fantamand2l, fantapapaya2l, fantapina2l, fantaguarana2l, mineragua2l, coca500, cocazero500, sprite500, fanta500, agua500, nombreFac, nitFac, referencia, latitud, longitud, arroz, papa, platano, idPed, estado, horaPed, fechaPed, total, iddel, latdel, londel)
                            listData.add(datos)
//
                        }
